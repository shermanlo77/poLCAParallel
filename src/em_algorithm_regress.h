 ...
 private:
  ...
  void CalcGrad() {
    ...
    for (int m = 1; m < this->n_cluster_; ++m) {
      ...
      for (int p = 0; p < this->n_feature_; ++p) {
        arma::Col<double> x_p(this->features_ + p * this->n_data_,
                              this->n_data_, false);
  ...
  void CalcHessSubBlock(int cluster_index_0, int cluster_index_1) {
    ...
    arma::Col<double> prior0(
        this->prior_ + (cluster_index_0 + 1) * this->n_data_, this->n_data_,
        false);
    ...
    arma::Col<double> prior1(
        this->prior_ + (cluster_index_1 + 1) * this->n_data_, this->n_data_,
        is_same_cluster);
  ...
  double CalcHessElement(int feature_index_0, int feature_index_1,
    ...
    arma::Col<double> feature0(
        this->features_ + feature_index_0 * this->n_data_, this->n_data_,
        false);
    arma::Col<double> feature1(
        this->features_ + feature_index_1 * this->n_data_, this->n_data_,
        false);
