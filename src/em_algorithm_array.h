...
class EmAlgorithmArray {
 ...
 public:
  ...
  int get_best_rep_index() { return this->best_rep_index_; }

  int get_n_iter() { return this->n_iter_; }

  bool get_has_restarted() { return this->has_restarted_; }
      ...
      if (this->n_rep_done_ < this->n_rep_) {
        ...
        if (n_feature == 1) {
          fitter = new polca_parallel::EmAlgorithm(
              ...
              this->initial_prob_ + rep_index * sum_outcomes * n_cluster,
              n_data, n_feature, this->n_category_, this->n_outcomes_,
              sum_outcomes, n_cluster, this->max_iter_, this->tolerance_,
